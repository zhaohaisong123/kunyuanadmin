  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="类型" prop="bannerType">
        <el-select v-model="queryParams.bannerType" placeholder="请选择类型" clearable>
          <el-option
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['kunyuan:banner:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['kunyuan:banner:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['kunyuan:banner:export']"
        >导出</el-button>
      </el-col>
...
<!--      <el-table-column label="ID" align="center" prop="bannerId" />-->
      ...
      <el-table-column label="类型" align="center" prop="bannerType">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.banner_type" :value="scope.row.bannerType"/>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="图片" prop="bannerImg">
          <image-upload v-model="form.bannerImg"  limit="1"/>
        </el-form-item>
        <el-form-item label="跳转地址" prop="linkUrl">
          <el-input v-model="form.linkUrl" placeholder="请输入跳转地址" />
        </el-form-item>
        <el-form-item label="类型" prop="bannerType">
          <el-select v-model="form.bannerType" placeholder="请选择类型">
            <el-option
              v-for="dict in dict.type.banner_type"
              :key="dict.value"
              :label="dict.label"
...
<script>
import { listBanner, getBanner, delBanner, addBanner, updateBanner } from "@/api/kunyuan/banner"

export default {
  name: "Banner",
  dicts: ['banner_type', 'sys_normal_disable'],
  data() {
    return {
      // 遮罩层
      loading: true,
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('kunyuan/banner/export', {
        ...this.queryParams
